...
Dossier de travail contenant le matériel de référence pour la refonte V2. À ne pas utiliser en production, c'est un point d'appui historique. Contient le `.grist` original et la documentation interne du schéma Grist de référence.
