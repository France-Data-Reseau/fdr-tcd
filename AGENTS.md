...
`docs_architecture/`. Schéma Grist de référence : `KIT_REBUILD_V2/SCHEMA_GRIST.md`.

## Règles absolues

1. **Ne jamais toucher** à l'app v1 (`fdr.revorun.eu`, service Docker `fdr`,
...
4. **UX/UI strictement identique à la v1** (`KIT_REBUILD_V2/reference_ui/`).
