"""
Listes de référence statiques.
Ces listes peuvent être éditées directement dans ce fichier.
"""

# --- Départements (numéro + nom) ---
DEPARTEMENTS = [
    "01 - Ain",
    "02 - Aisne",
    "03 - Allier",
...
# --- Connectivités (éditable) ---
CONNECTIVITES = [
    "LoRa privé",
    "LoRa opéré (Objenious, Orange, etc.)",
    "Sigfox",
    "NB-IoT",
    "LTE-M",
    "4G / 5G",
...
# --- Mapping département (numéro) → région ---
DEP_NUM_TO_REGION = {
