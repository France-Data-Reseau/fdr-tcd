"""Envoi d'emails (SMTP) : notifications administrateur.
...
- Les échecs d'envoi sont journalisés sans contenu sensible et ne produisent
    jamais de 500 côté utilisateur.
"""
